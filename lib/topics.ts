...
export const TOPICS: Topic[] = [
  ...
  },
  {
    ...
    question:
      "Out of 100 U.S. adults, how many could cover a surprise $400 expense without going into debt?",
    prompt: CORE_PROMPT,
    leftLabel: "ALMOST NONE",
    rightLabel: "ALMOST ALL",
  ...
  {
    id: "spend-foreign-aid",
    collection: "gap",
    battery: "budget",
    subject: "Foreign aid",
    axis: "Share of federal spending?",
    question: "Out of every $100 the U.S. government spends, how much goes to foreign aid?",
    prompt: CORE_PROMPT,
    leftLabel: "$0",
    rightLabel: "$100",
    highMeans: "a larger perceived share of federal spending going to foreign aid",
    scale: "amount",
    ...
    benchmark: {
      ...
      unit: "percent",
      sourceName: "Pew Research Center",
      sourceUrl: "https://www.pewresearch.org/short-reads/2025/02/06/what-the-data-says-about-us-foreign-aid/",
      fielded: "2023 · federal outlays, Pew analysis of U.S. government data",
      note:
        "The U.S. spent about $70 billion on foreign aid — roughly 1% of the federal budget. In a KFF poll, people guessed about 26%.",
    },
  },
  {
    id: "spend-nasa",
    ...
    subject: "NASA",
    axis: "Share of federal spending?",
    question: "Out of every $100 the U.S. government spends, how much goes to NASA?",
    prompt: CORE_PROMPT,
    leftLabel: "$0",
    rightLabel: "$100",
    highMeans: "a larger perceived share of federal spending going to NASA",
    scale: "amount",
    category: "Government spending",
    cadence: "once",
    benchmark: {
      ...
      sourceUrl: "https://www.planetary.org/space-policy/nasa-budget",
      fielded: "2024 · NASA share of federal outlays",
      note:
        "NASA is about 0.4% of federal spending. In one poll, people guessed around $6 of every $100.",
    },
  },
  {
    id: "spend-snap",
    collection: "gap",
    battery: "budget",
    subject: "Food stamps (SNAP)",
    axis: "Share of federal spending?",
    question: "Out of every $100 the U.S. government spends, how much goes to food stamps (SNAP)?",
    prompt: CORE_PROMPT,
    leftLabel: "$0",
    rightLabel: "$100",
    highMeans: "a larger perceived share of federal spending going to food stamps",
    scale: "amount",
    category: "Government spending",
    cadence: "once",
    benchmark: {
      ...
      unit: "percent",
      sourceName: "Pew Research Center",
      sourceUrl: "https://www.pewresearch.org/short-reads/2025/11/14/what-the-data-says-about-food-stamps-in-the-us/",
      fielded: "2024 · SNAP share of federal outlays",
      note:
        "Food stamps (SNAP) were about $100 billion in 2024 — roughly 1.6% of the federal budget.",
    },
  },
  {
    id: "spend-defense",
    ...
    axis: "Share of federal spending?",
    question: "Out of every $100 the U.S. government spends, how much goes to national defense?",
    prompt: CORE_PROMPT,
    leftLabel: "$0",
    rightLabel: "$100",
    highMeans: "a larger perceived share of federal spending going to national defense",
    scale: "amount",
    category: "Government spending",
    cadence: "once",
    benchmark: {
      ...
      sourceUrl: "https://www.cbo.gov/publication/60843/html",
      fielded: "FY2024 · federal outlays (~$6.75 trillion total)",
      note:
        "National defense was about $870 billion in 2024 — roughly 13% of federal spending.",
    },
  },
  {
    id: "spend-medicaid",
    ...
    subject: "Medicaid",
    axis: "Share of federal spending?",
    question: "Out of every $100 the U.S. government spends, how much goes to Medicaid?",
    prompt: CORE_PROMPT,
    leftLabel: "$0",
    rightLabel: "$100",
    highMeans: "a larger perceived share of federal spending going to Medicaid",
    scale: "amount",
    category: "Government spending",
    cadence: "once",
    benchmark: {
      ...
      fielded: "FY2024 · federal outlays (~$6.75 trillion total)",
      note:
        "Medicaid was about $620 billion in 2024 — roughly 9% of federal spending.",
    },
  },
  {
    id: "spend-medicare",
    ...
    subject: "Medicare",
    axis: "Share of federal spending?",
    question: "Out of every $100 the U.S. government spends, how much goes to Medicare?",
    prompt: CORE_PROMPT,
    leftLabel: "$0",
    rightLabel: "$100",
    highMeans: "a larger perceived share of federal spending going to Medicare",
    scale: "amount",
    category: "Government spending",
    cadence: "once",
    benchmark: {
      ...
      fielded: "FY2024 · federal outlays (~$6.75 trillion total)",
      note:
        "Medicare was about $850 billion in 2024 — roughly 13% of federal spending.",
    },
  },
  {
    id: "spend-social-security",
    collection: "gap",
    battery: "budget",
    subject: "Social Security",
    axis: "Share of federal spending?",
    question: "Out of every $100 the U.S. government spends, how much goes to Social Security?",
    prompt: CORE_PROMPT,
    leftLabel: "$0",
    rightLabel: "$100",
    highMeans: "a larger perceived share of federal spending going to Social Security",
    scale: "amount",
    category: "Government spending",
    cadence: "once",
    benchmark: {
      ...
      fielded: "FY2024 · federal outlays (~$6.75 trillion total)",
      note:
        "Social Security is the single biggest line — about $1.5 trillion, roughly 22% of federal spending.",
    },
  },
  {
    id: "spend-interest",
    collection: "gap",
    battery: "budget",
    subject: "Interest on the debt",
    axis: "Share of federal spending?",
    question: "Out of every $100 the U.S. government spends, how much goes just to interest on the national debt?",
    prompt: CORE_PROMPT,
    leftLabel: "$0",
    rightLabel: "$100",
    highMeans: "a larger perceived share of federal spending going to interest on the debt",
    scale: "amount",
    category: "Government spending",
    cadence: "once",
    benchmark: {
      ...
      fielded: "FY2024 · federal outlays (~$6.75 trillion total)",
      note:
        "Interest on the national debt reached about $880 billion in 2024 — roughly 13%, about the same as the entire defense budget, and rising fast.",
    },
  },
  {
